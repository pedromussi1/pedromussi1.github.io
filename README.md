...
### OCRbookfinder_Web
  ...
  * **Tools:**  Flask, Python, Tesseract, Google Books API, HTML/CSS/Javascript
...
<div>
<a href="https://youtu.be/nas4T9-hjTs">
...
### PernTodo
  ...
  * **Description:** This website was created to showcase my skills as a PERN developer. I designed and implemented the database schemas using PostgreSQL. I developed the logic on the server side and APIs using Express.js and Node.js. Created a responsive interface using React. And built a cohesive web application integrating the frontend and backend components.
...
### JWT with PERN
  * **Repository:**  https://github.com/pedromussi1/JWT
  * **Description:** This website was created to showcase my skills as a PERN developer along with using JSON Web Tokens
    to provide authentication and authorization for user logins. JWT was used to secure web APIs. When a user logs in,
    the server verifies the user's credentials. If they are valid, the server generates a JWT containing a set of claims
    and signs it using a secret key. The server sends this JWT back to the client. The client stores this token in the
...
### UnderThawed
  ...
  * **Future Developments:**  Develop an online multiplayer option to the game that uses Netcode for Game Objects
</div>
<br>
<hr>
...
<img align="right" height="270px" width="450px" src="https://i.imgur.com/J24FQYQ.gif" alt="html" style="vertical-align:top; margin:4px">  
</a>
...
<img align="right" height="270px" width="450px" src="https://i.imgur.com/Ocpwepy.gif" alt="html" style="vertical-align:top; margin:4px">  
</a>
